                  ...
                  <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-1">
                        ...
                        />
                        <p className="text-left text-croke-300 text-xs font-bold font-medium rounded-md mt-2"> {errors.firstname?.message}</p>
                      </div>
                    </div>
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-1">
                        ...
                        />
                        <p className="text-left text-croke-300 text-xs font-bold font-medium rounded-md mt-2">{errors.lastname?.message}</p>
                      </div>
                    </div>
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-1">
                        <input
                            ...
                            className="block w-full rounded-md border-croke shadow-sm focus:border-croke-200 focus:ring-croke-200 sm:text-sm"
                        />
                        <p className="text-left text-croke-300 text-xs font-bold font-medium rounded-md mt-2">{errors.email?.message}</p>
                      </div>
                    </div>
                    <div className="sm:col-span-3">
                    ...
                    <div className="sm:col-span-6">
                      ...
                      <div className="mt-1">
                        <textarea
                            ...
                            className="block w-full rounded-md border-croke shadow-sm focus:border-croke-200 focus:ring-croke-200 sm:text-sm"
                        />
                        <p className="text-left text-croke-300 text-xs font-bold font-medium rounded-md mt-2">{errors.message?.message}</p>
                      </div>
                    </div>
                  </div>
                </div>
