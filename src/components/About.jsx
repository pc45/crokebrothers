      ...
      <Container className="relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className=" mt-4 text-lg tracking-tight text-slate-700">
            Croke & Company offers video production, web design, polling,
            research, and related strategic guidance to organizations and
            ...
            clean design, and good humor to support our partners. Our goal is to
