...
const people = [
  {
    ...
    role: 'Founder',
    imageUrl: ryan,
    bio: 'Ryan has served in key leadership roles in Illinois through times of turbulence, crisis, and transition. As Chief of Staff to Secretary Grace Hou, the leader of State of Illinois’ largest agency during the administration of Governor JB Pritzker, Ryan developed expertise in a wide range of pandemic-era health and human services issues across the country - directly managing the offices of communications, legislative affairs and grants administration. Before that, he spearheaded a statewide association of nonprofits serving people with disabilities, and was responsible for campus safety, marketing, PR, HR, and government affairs as Associate Chancellor for Public Affairs the University of Illinois Springfield. From 2006-2015, he was a trusted advisor (including as Chief of Staff) to Illinois Governor Pat Quinn. He is the proud father of three kids with his wife Brook, and earned undergrad and masters degrees in communication at the University of Illinois at Urbana-Champaign.',
